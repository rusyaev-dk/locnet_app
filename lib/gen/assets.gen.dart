...
class $AssetsIconsGen {
  ...
  /// File path: assets/icons/locnet_logo.png
  AssetGenImage get locnetLogo =>
      const AssetGenImage('assets/icons/locnet_logo.png');

  /// List of all assets
  List<dynamic> get values => [gb, ru, uz, locnetLogo];
}
