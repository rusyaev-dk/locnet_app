...
class MessageContextMenuOverlay extends StatelessWidget {
  const MessageContextMenuOverlay({
  ...
  final List<MessageContextMenuAction> actions;
                  ...
                  child: DecoratedBox(
                    ...
                    child: ClipRRect(
                      ...
                      child: Column(
                        ...
                        children: [
                          for (final MessageContextMenuAction action in actions)
